...
<div class="col-xs-12 col-sm-4 col-md-9" style="float:right;">
      ...
      <div class="products-container">
         ...
         <?php
           ...
           $load_product = "select * from products where product_id = '$product_id'";
                ...
                echo "                    
					...
					<center>
                            <div class='detail-pic-box'>
                                <img src='admin/product_images/$pro_image1' alt='Product Image'>
                                <img src='admin/product_images/$pro_image2' alt='Prod
								uct Image'>
                                <img src='admin/product_images/$pro_image3' alt='Product Image'>
                            </div>
								
                            <h2>$pro_title</h2>
                             <p><h4><b>Ingredients: </b>$pro_price $</h4></p>
							 <p><h4>$pro_desc<h4></p>
                              <p><a href='index.php' class='btn btn-primary' role='button'>Go Back</a>
							  <a href='details.php?add_cart=$pro_id' class='btn btn-default' role='button' style='background:#665353'>Add to Favorites</a></p>
